...
{
	constexpr auto defaultini_path = L"Data/MCM/Config/Combined Combat XP Redux/settings.ini";
	constexpr auto userini_path = L"Data/MCM/Settings/Combined Combat XP Redux.ini";
